...
namespace QuintaEvaluacion.Controllers
{
    public class PhotosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Description,Slug,UserId,CreatedAt,UpdatedAt,DeletedAt")] Photo photo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Description,Slug,UserId,CreatedAt,UpdatedAt,DeletedAt")] Photo photo)
        {
            if (ModelState.IsValid)
            {
